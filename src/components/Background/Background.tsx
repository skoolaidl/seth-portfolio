...
const Background = (props: any) => {
    ...
    return(
        <BackgroundStyle id="visual" viewBox="0 0 3000 2000" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" version="1.1">
            <rect x="0" y="0" width="3000" height="2000" fill="#a88f8f"></rect>
            <defs>
